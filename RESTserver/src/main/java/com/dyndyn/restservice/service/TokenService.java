...
import com.dyndyn.restservice.security.authentication.CustomAuthenticationToken;
...
public class TokenService {
    ...
    @Autowired
    public TokenService(Environment environment, UserService userService, HexBinaryAdapter adapter) {
    ...
    public User getUserByToken(CustomAuthenticationToken token) {
        return token.isValid() ? userService.getByEmail(token.getUserName()) : null;
    }
